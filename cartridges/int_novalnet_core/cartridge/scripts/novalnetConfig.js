    ...
    switch (paymentId) {
        ...
        case 'NOVALNET_SEPA':
            return {
                ...
                zeroAmountBooking: currentSite.getCustomPreferenceValue('nnSepaZeroAmountBooking')
            };
        case 'NOVALNET_CREDITCARD':
            return {
                ...
                zeroAmountBooking: currentSite.getCustomPreferenceValue('nnCCZeroAmountBooking')
            };
