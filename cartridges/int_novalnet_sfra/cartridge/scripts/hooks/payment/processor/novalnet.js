    ...
    try {
        ...
        Transaction.wrap(function () {
            ...
            if (['NOVALNET_CREDITCARD', 'NOVALNET_SEPA', 'NOVALNET_GUARANTEED_SEPA', 'NOVALNET_INSTALMENT_SEPA'].indexOf(selectedPaymentMethodID) > -1) {
				if(config.oneclick === true && basket.getCustomer().isRegistered() === true) {
					if(paramsMap[paymentType + '_saved_token'].value === 'new_account_details' || !paramsMap[paymentType + '_saved_token'].value) {
